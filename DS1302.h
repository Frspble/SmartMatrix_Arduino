...
class DS1302 {
 public:
  ...
  // Returns the current time and date in a struct tm.
  //
  // Returns:
  //   Current time as struct tm.
  struct tm time();

  // Sets the time and date to the instant specified in a given struct tm.
  //
